...
export default {
  ...
  //   const title = ref(
  //     "Đây là tiêu đề của bài viết sẽ được hiển thị khi có dữ liệu."
  //   );
  //   const content = ref(
  //     `Chiều 9/8, áp thấp nhiệt đới ở phía đông bắc quần đảo Hoàng Sa đã mạnh lên thành bão, khả năng vào Đông Bắc Bộ, gây mưa trong ba ngày.
