    ...
    <div>
        <div class="d-flex mb-2">
            <div class="search-field d-flex">
                <span class="search-title d-block m-auto">Field</span>
                <select class="form-select ms-2 d-block minW-100">
                    <option>a</option>
                </select>
            </div>
            
            <div class="search-type ms-2 d-flex">
                <span class="search-title d-block m-auto">Type</span>
                <select class="form-select ms-2 d-block minW-100">
                    <option value="">>=</option>
                </select>
            </div>

            <div class="search-value ms-2 d-flex">
                <span class="search-value d-block m-auto">Value</span>
                <input type="input" class="form-control ms-2" placeholder="Search..." />
            </div>
        </div>
