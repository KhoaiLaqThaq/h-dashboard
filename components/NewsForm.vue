<template>
    <div class="d-flex">
            ...
            <BaseButton class="btn-primary ms-2" :btnType="'submit'" :name="'Save'" :textSize="'text-small'" @click="onSubmit" />
        ...
        <div class="row mt-3">
            ...
            <div class="col-4">
                <div class="box p-3">
                    <!-- type -->
                    <div class="mb-3">
                        <label for="" class="form-label">Loại tin tức <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        ...
                        <datepicker-lite :class-attr="'form-control'"  :name-attr="'createdDate'"
                            :show-bottom-button="true" :value-attr="createdDate" :locale="locale" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select v-model="type" id="" class="form-select" required="required" :value="type">
                            ...
                            <option v-for="(option, index) in topics" :key="index" :value="option">{{ option }}</option>
                        </select>
                    </div>
                    
                    <!-- tag -->
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" required="required" autocomplete="false" v-model="tag" @keyup.space="addTags()" />
                        <label for="">Thêm tag <span class="text-danger">*</span></label>
                        <div class="tags mt-2">
                            <span class="tag-item badge-primary" v-for="(tag, index) in tags" :key="index">{{ tag }}<XIcon class="ms-1" @click="removeTag(index)" /></span>
                        </div>
                    </div>
                </div>
            </div>
